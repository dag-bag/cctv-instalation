...
export default function Footer() {
  ...
  const organizationSchema = {
    ...
    "image": "https://www.camharbor.in/icon.png",
    "@id": "https://www.camharbor.in",
        ...
        <div className={styles.container}>
          <div className={styles.grid}>
            ...
            <div className={styles.column}>
              ...
              <p className={styles.text}>
                ...
                Trusted by thousands of customers with genuine service and expert technicians.
              </p>
              <div className={styles.socialLinks}>
                ...
                <a 
                  href={BUSINESS_CONFIG.social.twitter} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className={styles.socialLink}
                  aria-label="Twitter"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.135H6.314l7.227-8.26L5.145 2.25H18.244z"/>
                  </svg>
                </a>
                <a 
            ...
            <div className={styles.column}>
              ...
              <ul className={styles.linkList}>
                ...
                <li><Link href="/why-choose-us" className={styles.link}>Why Choose Us</Link></li>
              </ul>
            </div>
            ...
            <div className={styles.column}>
              ...
              <div className={styles.contactItem}>
                ...
                <a href={`tel:${BUSINESS_CONFIG.phone.replace(/\D/g, '')}`} className={styles.link}>{BUSINESS_CONFIG.phone}</a>
              </div>
              <div className={styles.contactItem}>
          ...
          <div className={styles.copyright}>
            ...
            <p className={styles.trustBadge}>
              <strong>✓ Genuine Service</strong> | <strong>✓ Expert Technicians</strong> | <strong>✓ 1-Year Warranty</strong>
            </p>
          </div>
        </div>
      </footer>
